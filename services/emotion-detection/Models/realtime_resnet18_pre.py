...
# Paths
EFFICIENTNET_WEIGHTS = "services/emotion-detection/Models/results/efficientnet_emotion (1).pt"   # Modify if located elsewhere
YOLO_WEIGHTS         = "services/emotion-detection/Models/yolov8n-face.pt"           # Or "yolov8n-face.pt" if in the same folder
